...
class NLToQueryDSL(dspy.Module):
    ...
    def forward(self, nl_query: str) -> dspy.Prediction:
        ...
        for _ in range(self.max_refine_attempts + 1):
            judge_result = self.dspy_judge._evaluate_query_dsl_syntax(
        ...
        final_judge_result = self.dspy_judge._evaluate_query_dsl_syntax(generated_query_dsl=current_query_dsl)
